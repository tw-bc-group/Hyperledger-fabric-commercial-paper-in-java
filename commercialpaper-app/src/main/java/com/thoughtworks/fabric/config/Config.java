package com.thoughtworks.fabric.config;
...
public class Config {
	...
	public static final String CHAINCODE_1_NAME = "commercialpaper";

	public static final String CHAINCODE_1_PATH = "commercialpaper.jar";// "github.com/commercialpaper";
