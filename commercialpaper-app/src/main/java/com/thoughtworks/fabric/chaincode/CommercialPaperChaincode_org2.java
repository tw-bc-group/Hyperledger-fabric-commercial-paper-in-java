...
public class CommercialPaperChaincode_org2 {
    ...
    private static void invoke(String funcName, String[] arguments) {
        try {
            ...
            for (ProposalResponse res : responses) {
                ...
                Logger.getLogger(CommercialPaperChaincode_org2.class.getName()).log(Level.INFO,
    ...
    public static CommercialPaper getBy(String paperNumber) {
        try {
            ...
            Logger.getLogger(CommercialPaperChaincode_org2.class.getName()).log(Level.INFO, "Querying for commercial papers ...");
            ...
            for (ProposalResponse pres : responsesQuery) {
                ...
                Logger.getLogger(CommercialPaperChaincode_org2.class.getName()).log(Level.INFO, stringResponse);
            }
            return paper;
        } catch (Exception e) {
            Logger.getLogger(CommercialPaperChaincode_org2.class.getName()).log(Level.SEVERE, e.getMessage());
            return null;
        }
    }

    public static void buy(BuyCommercialPaperRequest buyCommercialPaperRequest) {
        invoke("buy", new String[]{buyCommercialPaperRequest.getIssuer(), buyCommercialPaperRequest.getPaperNumber(), buyCommercialPaperRequest.getCurrentOwner(), buyCommercialPaperRequest.getNewOwner(), String.valueOf(buyCommercialPaperRequest.getPrice()), buyCommercialPaperRequest.getPurchaseDateTime()});
    }

    public static void redeem(RedeemCommercialPaperRequest req) {
        invoke("redeem", new String[]{req.getIssuer(), req.getPaperNumber(), req.getRedeemingOwner()});
    }
}
